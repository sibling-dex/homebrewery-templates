...
<img src="img/Dragonbrew.png" alt="A screenshot of the dragonbrew template" style="width:20%;max-width:128px;float:left">
...
## Dragonbrew Cards
<img src="img/Dragonbrew-Cards2.png" alt="A screenshot of the dragonbrew cards template" style="width:20%;max-width:128px;float:left">
...
## Shadowbrew
<img src="img/ShadowBrew.jpg" alt="A screenshot of the shadowbrew template" style="width:20%;max-width:128px;float:left">
...
## Mutantbrew
<img src="img/Mutantbrew.png" alt="A screenshot of the Mutantbrew template" style="width:20%;max-width:128px;float:left">
...
## Vaesenbrew
<img src="img/Vaesenbrew.png" alt="A screenshot of the Vaesenbrew template" style="width:20%;max-width:128px;float:left">

The [Vaesenbrew](https://homebrewery.naturalcrit.com/share/yvJpv9TksyEb) template is made for the Vaesen RPG by Free League.

<hr style="clear: both;">

<img src="thumbs/Codex Occultum - Missing Pages.png" alt="A screenshot of the Codex Occultum - Missing Pages template" style="width:20%;max-width:128px;float:left">
