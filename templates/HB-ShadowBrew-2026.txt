...
.page {
  ...
  .footnotes {
    position: absolute;
    inset: auto  var(--width-margins) calc(var(--width-margins) + 1em) var(--width-margins);
    width: 122mm;
  }
  ...
  &:has(.dark){
    background: black url(https://sibling-dex.github.io/homebrewery-templates/img/frame2.png) center / 95% 100% no-repeat;
...
- Added Spells Known table on page [11](#p11)
...
Here comes a spell description, keep it short but be precise.^1^

{{footnotes
^1^ You can also make footnotes now.

^†^ Thanks to Xethreau for the suggestion.
}}
{{pageNumber,auto}}
